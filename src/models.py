...
class People(db.Model):
    ...
    favorites: Mapped[List["PeopleFavorite"]] = relationship(
        back_populates="people", cascade="all, delete-orphan")
    people_films: Mapped[List["PeopleFilm"]] = relationship(
        back_populates="people", cascade="all, delete-orphan")
...
class Film(db.Model):
    ...
    film_vehicle: Mapped[List["FilmVehicles"]] = relationship(back_populates="film", cascade="all, delete-orphan")
...
class Planet(db.Model):
    ...
    planet_film: Mapped[List["FilmPlanet"]] = relationship(
...
class Vehicle(db.Model):
    ...
    vehicle_film: Mapped[List["FilmVehicles"]] = relationship(
